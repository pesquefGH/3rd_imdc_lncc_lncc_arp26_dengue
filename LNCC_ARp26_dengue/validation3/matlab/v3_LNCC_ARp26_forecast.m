% Validation 3: LNCC ARP26 forecast model (high-order AR(p) model)
...
ind_v3=649+52+52;  % index of the end of EW 25 of 2024 
% (upper bound observed data for validation 3)
...
lwea=2*52-25;   % number of EW to be forecast, i.e., from EW 26 of 2024 
% up to EW 52 2025 (will be cropped later to EW 41/2024 to EW 40/2025)
...
writetable(T,['..\spreadsheets\v3_ARp26_',num2str(state_code(1)),'.csv'],'Delimiter',',')
...
% from EW 41 of 2024 up to EW 40 of 2025
hold on;
