% Validation 4: LNCC ARP26 forecast model (high-order AR(p) model)
...
ind_v4=649+52+52+52;  % index of the end of EW 25 of 2025 
% (upper bound observed data for validation 4)

cc=kcc(1:ind_v4);  % observed cases from EW 1 of 2010 to EW 25 of 2025

cc(cc==0)=0.1;  % replaces null value in cc with a small value. This is 
% because we will apply 
% a log2 function to the data values. 

lwea=2*52-25;   % number of EW to be forecast, i.e., from EW 26 of 2025 
% up to EW 52 2026 (will be cropped later to EW 41/2025 to EW 40/2026)
...
% ensemble (7) of excitation signals of PP samples
...
pred = PP(5,:);  % 50% percentile - median forecast
...
writetable(T,['..\spreadsheets\v4_ARp26_',num2str(state_code(1)),'.csv'],'Delimiter',',')
...
cases=kcc(indf_ini:length(kcc));  % known observed dengue cases
% from EW 41 of 2025 to EW 52 of 2025

figure
subplot(221)
plot(indf_ini:length(kcc),cases,'linewidth',2); % plot known sequence of 
% cases % from EW 41 of 2025 up to EW 52 of 2025
hold on;
