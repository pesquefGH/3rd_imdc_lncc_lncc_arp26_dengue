% Validation 2: LNCC ARP26 forecast model (high-order AR(p) model)
...
ind_v2=649+52;  % index of the end of EW 25 of 2023 
% (upper bound observed data for validation 2)
...
lwea=2*52-25;   % number of EW to be forecast, i.e., from EW 26 of 2023 
% up to EW 52 2024 (will be cropped later to EW 41/2023 to EW 40/2024)
...
writetable(T,['..\spreadsheets\v2_ARp26_',num2str(state_code(1)),'.csv'],'Delimiter',',')
...
% from EW 41 of 2023 up to EW 40 of 2024
hold on;
